...
alphas1 = np.array([[20,1,80,2,3],[20,1,80,2,3],[20,1,2,80,3],[20,1,2,3,80],[20,1,2,4,80]])
alphas2=  np.array([[80,20,1,2,3],[80,2,20,1,3],[80,1,2,2,20],[80,1,4,1,20],[80,4,2,1,20]])
...
plt.legend(bbox_to_anchor=(1, 1), loc=2, borderaxespad=0.)
plt.show()
print("fsc rewards for bad prior matrix" ,cum_reward)
print("optimal cum rewards", optimal_cum_reward)
