...
#print(a_updated)
#
j_updated= np.random.choice(N,p=P_updated[i,:,a_updated].T)
print(j_updated)
#c_count = c_count+1
q0_updated = np.random.choice(Q,p=eta[i,q0_updated,j_updated,:,a_updated].T)
current_reward = R [i,j_updated,a_updated]

#print(current_reward)
cum_reward = cum_reward + current_reward
